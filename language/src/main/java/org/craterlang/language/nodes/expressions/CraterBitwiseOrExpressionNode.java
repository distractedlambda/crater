...
public abstract class CraterBitwiseOrExpressionNode extends CraterBinaryExpressionNode  {
    public static CraterBitwiseOrExpressionNode create(CraterExpressionNode lhsNode, CraterExpressionNode rhsNode) {
        return CraterBitwiseOrExpressionNodeGen.create(lhsNode, rhsNode);
    }
