...
import org.craterlang.language.nodes.builtins.BuiltinFunctionBodyNode;
...
public abstract class TablePackNode extends BuiltinFunctionBodyNode {
    public static Supplier<TablePackNode> getFactory() {
        return TablePackNodeGen::create;
    }
