...
public abstract class BitwiseXOrExpressionNode extends BinaryExpressionNode {
    public static BitwiseXOrExpressionNode create(ExpressionNode lhsNode, ExpressionNode rhsNode) {
        return BitwiseXOrExpressionNodeGen.create(lhsNode, rhsNode);
    }
