...
public abstract class AddExpressionNode extends BinaryExpressionNode {
    public static AddExpressionNode create(ExpressionNode lhsNode, ExpressionNode rhsNode) {
        return AddExpressionNodeGen.create(lhsNode, rhsNode);
    }
