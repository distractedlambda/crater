...
public abstract class BitwiseAndExpressionNode extends BinaryExpressionNode {
    public static BitwiseAndExpressionNode create(ExpressionNode lhsNode, ExpressionNode rhsNode) {
        return BitwiseAndExpressionNodeGen.create(lhsNode, rhsNode);
    }
    ...
    Object doMetamethod(Object lhs, Object rhs, @Cached BinaryMetamethodInvokeNode metamethodInvokeNode) {
        return metamethodInvokeNode.execute(lhs, rhs, getLanguage().getBandMetamethodKey());
    }
}
