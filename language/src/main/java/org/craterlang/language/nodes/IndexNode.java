...
public abstract class IndexNode extends CraterNode {
    public abstract Object execute(Object receiver, Object key);

    public static IndexNode create() {
        return IndexNodeGen.create();
    }

    public static IndexNode getUncached() {
        return IndexNodeGen.getUncached();
    }
    ...
    static abstract class MetavalueDispatchNode extends CraterNode {
        ...
        @Fallback
        Object doNestedIndex(Object receiver, Object key, Object metavalue, @Cached IndexNode nestedIndexNode) {
