...
public abstract class MulExpressionNode extends BinaryExpressionNode {
    public static MulExpressionNode create(ExpressionNode lhsNode, ExpressionNode rhsNode) {
        return MulExpressionNodeGen.create(lhsNode, rhsNode);
    }
